# Server response review · faulty case

Target: prepared-faulty-v1. Review only the changed response-status line.
...
Prepared fixture record for this exact case: new-child response expected 202, received 200 — failed at the status assertion; reused-child response equals 200 — passed; Location and result identifier agree — passed. These are supplied case inputs, not execution of a participant’s application. No browser checks are included.
