...
2. In a fresh session for each case, run `/spec-to-build review-only .claude/skills/spec-to-build/evals/<case>.md`. Permit Read/Grep/Glob only. Supply only that case and the review procedure. The filenames are task1-correct.md, task1-faulty.md, task2-correct.md and task2-faulty.md.
