...
export interface FollowUp { id: string; inspectionId: string; findingId: string; note: string; status: 'open' | 'resolved'; createdAt: string; resolvedAt: string | null }
export interface ApiError { error: { code: string; message: string }; followUp?: FollowUp }
